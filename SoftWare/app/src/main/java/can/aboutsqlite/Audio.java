...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + "if not exists " + TABLE2_NAME + " ("
                ...
                + "memo_priority integer(1) not null default 1,"
                + "memo_periodicity integer(1) not null default 0,"/*设置周期提醒时间默认为无周期*/
        ...
        db.execSQL("insert into "+TABLE2_NAME+"(" +
                "memo_title,user_id,memo_dtime) "
                + "values ('Im a cat!',1,'20181101'),"
                + "('Im a puppy!',1,'20181122'),"
                + "('Im a cattle!',1,'20181128'),"
                + "('Im a bird!',1,'20181130'),"
                + "('Im a hourse!',1,'20181230')");
    }
