...
//		/*【飞猪提醒】飞机*/
		SMSText = "【飞猪提醒】1-03 14:00羽田机场D2飞-10-03 15:05伊丹机场降全日空航空NH027，订单1256508639143(航空公司订单号：1808262003121b96fb6)已"
...
//		SMSText = "【铁路客服】订单E825928628,胡青元您已购9月1日D6216次7车3A号,厦门北站15:29开{,检票口：二层7号检票口}。";
		if (needDeliverySMS != 0 || needTicketSMS != 0) {
			...
			if (needDeliverySMS != 0 && isDeliverySMS != 0) {
				...
				System.out.println("标题：" + test.getTitle());
				System.out.println("----------------------");
			...
			if (needTicketSMS != 0 && isTicketSMS != 0) {
				...
				System.out.println("标题：" + test.getTitle());
				System.out.println("截止时间：" + test.getTicketEndTime());
				System.out.println("----------------------");
				System.out.println(test.getKeyContent());	
			}
			test.getTitle();
